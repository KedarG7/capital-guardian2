...
export default function Login({ onRegister }) {
  ...
  return (
    <main className="min-h-screen grid place-items-center p-6 bg-gradient-to-br from-[#f2f7f5] to-[#e4eee9] font-['Manrope',sans-serif] text-[#10242a]">
      <div className="w-full max-w-[420px] bg-white/95 backdrop-blur-xl p-8 sm:p-10 border border-[#d9e4df] rounded-2xl shadow-[0_24px_80px_rgba(16,36,42,0.06)] motion-safe:animate-[fade-in-up_0.5s_ease-out_forwards]">
        ...
        <div className="mb-8 motion-safe:animate-[fade-in-up_0.6s_ease-out_forwards] opacity-0" style={{ animationDelay: '100ms' }}>
          <h1 className="text-2xl font-bold tracking-tight text-[#173b3d] mb-2">Welcome back.</h1>
          <p className="text-[#71817e] text-sm">Sign in to your capital workspace.</p>
        </div>
        ...
        <form onSubmit={submit} className="flex flex-col gap-4 motion-safe:animate-[fade-in-up_0.6s_ease-out_forwards] opacity-0" style={{ animationDelay: '150ms' }}>
          <div className="flex flex-col gap-1.5">
            <label htmlFor="login-email" className="text-[10px] uppercase tracking-wider font-['DM_Mono',monospace] text-[#5f7771] font-bold">Email</label>
            <input 
              id="login-email" 
              type="email" 
              autoComplete="email" 
          ...
          <div className="flex flex-col gap-1.5 relative">
            <label htmlFor="login-password" className="text-[10px] uppercase tracking-wider font-['DM_Mono',monospace] text-[#5f7771] font-bold">Password</label>
        ...
        <p className="mt-8 text-center text-sm text-[#71817e] motion-safe:animate-[fade-in-up_0.6s_ease-out_forwards] opacity-0" style={{ animationDelay: '200ms' }}>
          Don't have an account? <button type="button" onClick={onRegister} className="font-bold text-[#0f766e] hover:text-[#14383b] transition-colors ml-1">Create account</button>
        </p>
      </div>
    </main>
  )
