...
export const amount = (value) => currency.format(value)
export const signedPercent = (value) => `${value >= 0 ? '+' : ''}${percent(value)}`
...
export function ExplanationCard({ explanation }) {
  ...
  // Fallback to legacy structure if needed, but UI accommodates both cleanly
  return (
    <section className="panel explanation-card bg-white shadow-sm border border-gray-200 rounded-xl mt-8" aria-live="polite">
      ...
      <div className="p-6 space-y-8">
        ...
        {/* Legacy Support for metrics/impact/actions if new fields aren't populated */}
